  ...
  <input type="Checkbox" id="C1" Value="Upload Bytes" onclick="uploadappear();">
   ...
   <p id="text1" style="display:none">
	<b style="font-size: large;">
   	...
   	<br>
	<img src="/streaming_provider_classifier_inside_vpn/assets/prime_upload.png" width="215" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/netflix_upload.png" width="215" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/youtube_upload.png" width="215" >
	<br>
    	<img src="/streaming_provider_classifier_inside_vpn/assets/twitch_upload.png" width="230" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/youtube_live_upload.png" width = "230">
	<br>
