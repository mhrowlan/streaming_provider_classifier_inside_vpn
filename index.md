...
<p>Click on the boxes to explore data analysis of each provider.</p>
  ...
  <label FOR="C1"></label>
	<p style="font-size: x-large;"> Upload Bytes
  <input type="Checkbox" id="C1" Value="Upload Bytes" onclick="uploadappear();">
   ...
   <p id="text1" style="display:none">
	<b style="font-size: large;">Upload Bytes: Data Analysis</b>
	</p>
   	<br>
	...
	<br>
<p> In the graphs above, it is visible how the flow of download bytes have a unique pattern in each provider. For the 
...
<div style="line-height:10px;"></div> 
  ...
  <p id="text2" style="display:none"></p>
	...
	<br>
<p>In the graphs above, it is visible how the flow of upload bytes have the key difference of spike frequency and dimensionality of the spikes. 
