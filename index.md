...
### Video On Demand
<section class = "tabchange" id="content3" style="display:none">
<p>Click on the boxes to explore data analysis of each provider.</p>

  <label FOR="C1">Upload Bytes</label>
  <input type="Checkbox" id="C1" Value="Upload Bytes" onclick="uploadappear();" checked>



  <label FOR="C2">Download Bytes</label>
  <input TYPE="Checkbox" id="C2" Value="Download Bytes" onclick="downloadappear();" checked>
  
  <br>
  
  <p id="text1" style="display:none"><b style="font-size: large;">Upload Packet Data</b><br><br>
				<b><a href="https://www.ai-paths.org/" target="_blank">AI Paths</a></b>: supports minorties in Data Science and AI.<br><br>
 ...
 <div style="line-height:10px;"><br></div> 
  ...
  <p id="text2" style="display:none"><b style="font-size: large;">Download Packet Data</b><br><br>
    <b><a href="https://aep.ucsd.edu/" target="_blank">UCSD Academic Enrichment Programs</a></b>: A range of scholarships for summer research at UCSD.<br><br>
