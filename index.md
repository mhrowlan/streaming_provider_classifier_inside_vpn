...
<p>Click on the boxes to explore data analysis of each provider.</p>
  ...
  <label FOR="C1"><p style="font-size: x-large;">Upload Bytes</label>
      <input type="Checkbox" id="C1" Value="Upload Bytes" onclick="uploadappear();" checked>
    
    <br>
    
   <label FOR="C2"><p style="font-size: x-large;">Download Bytes</label>
   ...
   <br><br>
	<img src="/streaming_provider_classifier_inside_vpn/assets/prime_upload.png" width="350" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/netflix_upload.png" width="350" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/youtube_upload.png" width="350" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/twitch_live_upload.png" width="350" >
    	<img src="/streaming_provider_classifier_inside_vpn/assets/youtube_live_upload.png" width = "350">
 ...
 <div style="line-height:10px;"><br></div> 
  ...
  <p id="text2" style="display:none"><b style="font-size: large;">Download Bytes: Data Analysis</b>
	...
	<br>
        ...
        For Netflix there iare large sporadic spikes that occur often. 
